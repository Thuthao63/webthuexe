...
<section class = "cartegory">
    <div class = "vehicle">
		<p>Xe Máy <span>&#160;</span> - <span>&#160;</span> Yamaha</p>
    </div>
</section>
...
<section id="exciter">
    ...
    <div class="cartegory-right-content row">
		...
		$sql = "SELECT * FROM xe WHERE STT >=29 AND STT <=33";
...
<section id="sirius">
    ...
    <div class="cartegory-right-content row">
        ...
        // Truy vấn lấy dữ liệu từ bảng xe
		$sql = "SELECT * FROM xe WHERE STT>=44 AND STT<=48";
        $result = $conn->query($sql);
...
<section id="jupiter">
    ...
    <div class="cartegory-right-content row">
        ...
        // Truy vấn lấy dữ liệu từ bảng xe
		$sql = "SELECT * FROM xe WHERE STT>=38 AND STT<=39";
        $result = $conn->query($sql);
