...
<section id="tundra">
    ...
    <div class="cartegory-right-content row">
		...
		$sql = "SELECT * FROM xe WHERE STT>=84 AND STT<=85";
...
<section id="tacoma">
    ...
    <div class="cartegory-right-content row">
        ...
        // Truy vấn lấy dữ liệu từ bảng xe
		$sql = "SELECT * FROM xe WHERE STT>=81 AND STT<=83";
        $result = $conn->query($sql);
...
<section id="rav4">
    ...
    <div class="cartegory-right-content row">
        ...
        // Truy vấn lấy dữ liệu từ bảng xe
		$sql = "SELECT * FROM xe WHERE STT>=78 AND STT<=80";
        $result = $conn->query($sql);
...
<section id="prius">
    ...
    <div class="cartegory-right-content row">
        ...
        // Truy vấn lấy dữ liệu từ bảng xe
		$sql = "SELECT * FROM xe WHERE STT>=76 AND STT<=77";
        $result = $conn->query($sql);
...
<section id="highlander">
    ...
    <div class="cartegory-right-content row">
        ...
        // Truy vấn lấy dữ liệu từ bảng xe
		$sql = "SELECT * FROM xe WHERE STT>=73 AND STT<=75";
        $result = $conn->query($sql);
