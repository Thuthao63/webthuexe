...
<section id="vstrom">
    ...
    <div class="cartegory-right-content row">
		...
		$sql = "SELECT * FROM xe WHERE STT>=64 AND STT<=65";
...
<section id="smash">
    ...
    <div class="cartegory-right-content row">
        ...
        // Truy vấn lấy dữ liệu từ bảng xe
		$sql = "SELECT * FROM xe WHERE STT>=51 AND STT<=53";
        $result = $conn->query($sql);
...
<section id="skydriver">
    ...
    <div class="cartegory-right-content row">
        ...
        // Truy vấn lấy dữ liệu từ bảng xe
		$sql = "SELECT * FROM xe WHERE STT>=54 AND STT<=55";
        $result = $conn->query($sql);
...
<section id="satria">
    ...
    <div class="cartegory-right-content row">
        ...
        // Truy vấn lấy dữ liệu từ bảng xe
		$sql = "SELECT * FROM xe WHERE STT>=66 AND STT<=69";
        $result = $conn->query($sql);
...
<section id="raider">
    ...
    <div class="cartegory-right-content row">
        ...
        // Truy vấn lấy dữ liệu từ bảng xe
		$sql = "SELECT * FROM xe WHERE STT>=56 AND STT<=59";
        $result = $conn->query($sql);
...
<section id="gsx">
    ...
    <div class="cartegory-right-content row">
        ...
        // Truy vấn lấy dữ liệu từ bảng xe
		$sql = "SELECT * FROM xe WHERE STT>=60 AND STT<=61";
        $result = $conn->query($sql);
...
<section id="address">
    ...
    <div class="cartegory-right-content row">
        ...
        // Truy vấn lấy dữ liệu từ bảng xe
		$sql = "SELECT * FROM xe WHERE STT>=62 AND STT<=63";
        $result = $conn->query($sql);
