...
<section class = "cartegory">
    <div class = "vehicle">
		<p>Xe Hơi <span>&#160;</span> - <span>&#160;</span> Ford</p>
    </div>
</section>
...
<section id="fordEdge">
    ...
    <div class="cartegory-right-content row">
		...
		$sql = "SELECT * FROM xe WHERE STT>=86 AND STT<=87";
...
<section id="fordEscape">
    ...
    <div class="cartegory-right-content row">
        ...
        // Truy vấn lấy dữ liệu từ bảng xe
		$sql = "SELECT * FROM xe WHERE STT>=88 AND STT<=89";
        $result = $conn->query($sql);
...
<section id="fordExplorer">
    ...
    <div class="cartegory-right-content row">
        ...
        // Truy vấn lấy dữ liệu từ bảng xe
		$sql = "SELECT * FROM xe WHERE STT>=90 AND STT<=91";
        $result = $conn->query($sql);
...
<section id="fordF150">
    ...
    <div class="cartegory-right-content row">
        ...
        // Truy vấn lấy dữ liệu từ bảng xe
		$sql = "SELECT * FROM xe WHERE STT>=92 AND STT<=93";
        $result = $conn->query($sql);
...
<section id="fordFocus">
    ...
    <div class="cartegory-right-content row">
        ...
        // Truy vấn lấy dữ liệu từ bảng xe
		$sql = "SELECT * FROM xe WHERE STT>=94 AND STT<=95";
        $result = $conn->query($sql);
...
<section id="fordRanger">
    ...
    <div class="cartegory-right-content row">
        ...
        // Truy vấn lấy dữ liệu từ bảng xe
		$sql = "SELECT * FROM xe WHERE STT>=96 AND STT<=97";
        $result = $conn->query($sql);
